...
- [ ] Add an email address to the `ADMINS` settings variable in `dragsreng/dragsreng/settings/base.py`
- [ ] Change the `SERVER_EMAIL` to the email address used to send e-mails in `dragsreng/dragsreng/settings/production.py`
...
- Create a copy of ``dragsreng/settings/local.py.example``:  
  `cp dragsreng/settings/local.py.example dragsreng/settings/local.py` (remembering you should replace `dragsreng` with your project's name!).
